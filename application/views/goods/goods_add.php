        ...
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="fname" name="fname" lay-verify="fname"
                        ...
                        <select name="ftid" id="ftid" lay-verify="ftid">
                            <?php if (isset($typelist) && !empty($typelist)) { ?>
                                ...
                                <?php foreach ($typelist as $k => $v) : ?>
                                    <option value="<?= $v['ftid'] ?>"><?= $v['fname'] ?></option>
                                <?php endforeach; ?>
                            <?php } ?>
                        </select>
                    </div>
			...
			<div class="layui-form-item" id="op1" style="display: none;">
				<label for="L_pass" class="layui-form-label" style="width: 30%;">
			...
			<div class="layui-form-item" id="op2" style="display: none;">
				<label for="L_pass" class="layui-form-label" style="width: 30%;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 500px;">
					<input type="radio" name="is_open" lay-skin="primary" title="上传账号可编辑、删除。" value="1" checked>
					<input type="radio" name="is_open" lay-skin="primary" title="全员账号可编辑、删除。" value="0">
				</div>
			</div>
<!--            <div class="layui-form-item">-->
<!--                <label for="L_pass" class="layui-form-label" style="width: 30%;">-->
